...
{
    /// <inheritdoc />
    public partial class AddLibraryDomain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BorrowingSettingsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LibraryId = table.Column<int>(type: "int", nullable: false),
                    LoanDurationDays = table.Column<int>(type: "int", nullable: false),
                    RenewalLimit = table.Column<int>(type: "int", nullable: false),
                    OverduePenalty = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    MaximumBorrowableItems = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowingSettings", x => x.BorrowingSettingsId);
                    table.ForeignKey(
                        name: "FK_BorrowingSettings_Libraries_LibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowingSettings_LibraryId",
                table: "BorrowingSettings",
                column: "LibraryId",
                unique: true);
